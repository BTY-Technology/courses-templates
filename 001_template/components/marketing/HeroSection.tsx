...
export function HeroSection() {
  ...
  return (
    <section id="hero-bg-animation" className="relative lg:sticky lg:top-0 bg-gradient-to-br from-primary/5 via-white to-primary/10 pt-24 pb-12 lg:pt-32 lg:pb-20 overflow-hidden min-h-screen flex items-center z-0 -mt-[72px]">
      {/* Wave backgrounds */}
      ...
      <div className="container mx-auto px-4 max-w-content relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 animate-fade-in relative bg-white/60 backdrop-blur-md rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-white/40 order-2 lg:order-1">
            ...
            <div className="hidden lg:block absolute -bottom-20 right-10 w-32 h-32 bg-success/10 rounded-full blur-2xl animate-float -z-10" style={{ animationDelay: '1s' }} />
            {/* Trust Badges */}
            ...
            <div>
              <h1 className="font-heading font-heading-extrabold text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-4 drop-shadow-lg">
                Pass Your ASWB Exam{' '}
                <span className="text-primary drop-shadow-lg">with Confidence</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-700 font-body font-body-normal drop-shadow-sm">
                Prep smarter, not harder. Join thousands of social workers who passed on their first try with John&apos;s proven methodology.
              </p>
            </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-lg text-gray-800 font-body drop-shadow-sm">{item}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in">
              ...
              <Button size="lg" variant="outline" onClick={handleFreeGuideClick}>
            ...
            <div className="flex items-center gap-3 pt-4 animate-fade-in">
              <div className="flex -space-x-2">
                <img className="w-10 h-10 rounded-full border-2 border-white shadow-md" src="https://randomuser.me/api/portraits/women/62.jpg" alt="Student" />
                <img className="w-10 h-10 rounded-full border-2 border-white shadow-md" src="https://randomuser.me/api/portraits/men/32.jpg" alt="Student" />
                <img className="w-10 h-10 rounded-full border-2 border-white shadow-md" src="https://randomuser.me/api/portraits/women/44.jpg" alt="Student" />
                <img className="w-10 h-10 rounded-full border-2 border-white shadow-md" src="https://randomuser.me/api/portraits/men/75.jpg" alt="Student" />
              </div>
              <p className="text-sm text-gray-700 font-body drop-shadow-sm">
                Join <span className="font-heading-semibold text-accent">2,000+</span> people finding their path
              </p>
            </div>
          </div>
          ...
          <div className="relative animate-slide-up order-1 lg:order-2">
            ...
            <div className="absolute -bottom-4 -left-4 lg:-bottom-6 lg:-left-6 bg-white rounded-xl shadow-card-hover p-4 lg:p-6 border border-neutral-border max-w-[160px] lg:max-w-[200px]">
              <div className="text-center">
                <p className="font-accent font-accent-bold text-3xl lg:text-4xl text-primary mb-1">89%</p>
                <p className="text-xs lg:text-sm text-text-secondary font-body">Pass Rate</p>
              </div>
            </div>
          </div>
        </div>
